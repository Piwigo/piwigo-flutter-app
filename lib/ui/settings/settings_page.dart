...
import 'package:piwigo_ng/ui/core/ui/appbars/settings_app_bar.dart';
import 'package:piwigo_ng/ui/core/ui/sections/settings_section.dart';
import 'package:piwigo_ng/domain/models/info_model.dart';
import 'package:piwigo_ng/data/services/api/api_error.dart';
import 'package:piwigo_ng/data/services/api/authentication.dart';
            ...
            SliverPadding(
              ...
              sliver: SliverList(
                delegate: SliverChildListDelegate([
                  ...
                  if (appPreferences.getBool(Preferences.isAdminKey) ?? false) _uploadSection,
                  // _privacySection,
                  _appearanceSection,
                  _cacheSection,
                  _infoSection,
  ...
  Widget get _uploadSection => SettingsSection(
        ...
        children: [
          ...
          SettingsSectionItemSwitch(
            ...
            onChanged: (_) => Navigator.of(context).pushNamed(AutoUploadPage.routeName).then((_) => setState(() {
                  _autoUploadEnabled = AutoUploadPreferences.getEnabled;
                })),
          ),
          // SettingsSectionItemSwitch(
  ...
  Widget get _infoSection => SettingsSection(
        ...
        children: [
          ...
          SettingsSectionItemButton(
            ...
            onPressed: () => Navigator.of(context).pushNamed(SelectLanguagePage.routeName),
          ),
          SettingsSectionItemButton(
